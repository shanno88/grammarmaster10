              ...
              <div className="p-6 overflow-y-auto custom-scrollbar flex-1 space-y-6">
                <div className="space-y-5">
                  <div className="space-y-3">
                    <p className="text-xs font-black text-slate-400 uppercase tracking-widest text-center">输入激活码</p>
                    <input 
                      type="text" 
                      placeholder="在此输入激活码"
                  ...
                  <div className="bg-slate-50 p-2.5 rounded-[14px] border border-slate-100">
                    <p className="text-[10px] text-slate-500 leading-relaxed">请输入有效的激活码以解锁 Pro 会员功能。</p>
                  </div>
                </div>
              </div>
            </div>
