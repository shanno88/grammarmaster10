  ...
  return (
    <div className="min-h-screen bg-[#F0F9FF] font-sans text-slate-700 flex justify-center items-start pt-6 pb-10 px-4">
      {currentPage === 'billing' ? (
        ...
        <div className="w-full max-w-[450px] bg-white shadow-2xl rounded-[32px] overflow-hidden border-4 border-white ring-4 ring-indigo-100 flex flex-col min-h-[780px] relative transition-all duration-300 mx-auto">
